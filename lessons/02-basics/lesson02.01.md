...
- [Вложенные пространства имен](#вложенные-пространства-имен)
- [Глобальное пространство имен](#глобальное-пространство-имен)
- [Анонимные пространства имен](#анонимные-пространства-имен)
- [Inline-пространства имен (`C++11`)](#inline-пространства-имен-c11)
- [Псевдонимы пространств имен](#псевдонимы-пространств-имен)
- [Директива `using`](#директива-using)
- [Пространства имен `std`](#пространства-имен-std)
